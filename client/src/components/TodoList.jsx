...
function TodoList({ setButtonLabel }) {
  ...
  const filteredByCompleted = useSelector(state => state.todo.filteredByCompleted)
  ...
  const tasksForSelectedDay = sortedTodos.filter(todo => isSameDay(selectedDay, todo.startTime))
